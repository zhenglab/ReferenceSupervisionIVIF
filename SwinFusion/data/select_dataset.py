...
def define_Dataset(dataset_opt):
    ...
    # -----------------------------------------
    elif dataset_type in ['mef_GT', 'mff_GT', 'vif_gt']:
        from data.dataset_mef_3 import DatasetMEF as D
    elif dataset_type in ['mef', 'vif', 'mff', 'nir', 'med']:
        from data.dataset_wogt import Dataset as D
    elif dataset_type in ['vif_gt_5']:
        from data.dataset_vif_5 import DatasetMEF as D
    elif dataset_type in ['vif_gt_2']:
        from data.dataset_vif_2 import DatasetMEF as D    
    elif dataset_type in ['vif_gt_7']:
        from data.dataset_vif_7 import DatasetMEF as D
    elif dataset_type in ['vif_gt_9']:
        from data.dataset_vif_9 import DatasetMEF as D
    # -----------------------------------------
    # common
    # -----------------------------------------
