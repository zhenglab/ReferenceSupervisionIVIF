...
class DatasetMEF(data.Dataset): 
    ...
    def __init__(self, opt):
        ...
        self.paths_GT_2 = self.paths_GT.replace("1_enhance", "2_enhance")
        self.paths_GT_3 = self.paths_GT.replace("1_enhance", "3_enhance")
        # self.paths_GT = self.paths_GT.replace("1_enhance", "2_enhance")
    ...
    def __getitem__(self, index):
        ...
        return {'A': img_A, 'B': img_B, 'GT': img_GT, 'GT_2': img_GT_2, 'GT_3': img_GT_3,'A_path': A_path, 'B_path': B_path, 'GT_path': GT_path}
